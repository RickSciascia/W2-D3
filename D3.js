...
console.log(
  "Elenco di tutti i personaggi all interno dell'Array characterNames",
  characterNames
);
/* ESERCIZIO 3
...
console.log("eyeColor è ", eyeColor);
...
while (index < starWarsCharacters.length) {
  crewMass = starWarsCharacters[index].mass + crewMass;
  console.log("passaggio", index + 1, "il crewMass ora è", crewMass);
  index = index + 1;
}
console.log("a fine ciclo Il crewMass totale è ", crewMass);
